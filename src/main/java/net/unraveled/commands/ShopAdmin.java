        ...
        if (args.length == 3) {
            ...
            if (args[1].equalsIgnoreCase("all")) {
                ...
                switch (args[0].toLowerCase()) {
                    ...
                    case "add":
                        ...
                        return true;
                    case "del":
                        sender.sendMessage(ChatColor.GRAY + "Couldn't remove coins from everybody.");
                        return true;
                }
            }
            ...
            switch (args[0].toLowerCase()) {
                ...
                case "del":
                    ...
                    if (index == 0) {
                        sender.sendMessage(ChatColor.GRAY + "Took away that player's coins.");
                        return true;
                    }
                    sender.sendMessage(
        ...
        if (args.length == 2) {
            if (args[0].equalsIgnoreCase("get")) {
                ...
                if (player != null) {
                    ...
                    if (tCoins == 0) {
                        sender.sendMessage(
                                ChatColor.GRAY + "That player doesn't have any coins.");
                        return true;
                    }
