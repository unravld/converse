...
@CommandParameters(description = "Lists or clears all invisible players on the server.", usage = "/<command> [clear]")
public class Invis extends CommandBase {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (invisplayers.isEmpty()) {
            sender.sendMessage(ChatColor.GRAY + "There are no invisible players");
            return true;
        }
